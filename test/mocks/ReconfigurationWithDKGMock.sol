...
contract ReconfigurationWithDKGMock is IReconfigurationWithDKG {
    ...
    function finishWithDkgResult(bytes calldata dkgResult) external override {
    ...
    function setShouldFailTryStart(bool _shouldFail) external {
    ...
    function setShouldFailFinishWithDkgResult(bool _shouldFail) external {
        shouldFailFinishWithDkgResult = _shouldFail;
    }

    function setReconfigurationInProgress(bool _inProgress) external {
