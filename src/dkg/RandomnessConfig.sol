...
contract RandomnessConfig is System, Protectable, IRandomnessConfig {
    ...
    function initialize(RandomnessConfigData memory config) external onlyGenesis {
    ...
    /// @inheritdoc IRandomnessConfig
    function setForNextEpoch(RandomnessConfigData memory newConfig) external onlyAuthorizedCallers whenNotPaused onlyInitialized {
    ...
    /// @inheritdoc IRandomnessConfig
    function toIDKGConfig(RandomnessConfigData memory config) external pure returns (IDKG.Config memory) {
    ...
    /// @inheritdoc IRandomnessConfig
    function getVariantName(RandomnessConfigData memory config) external pure returns (string memory) {
     ...
     */
    function _validateConfig(RandomnessConfigData memory config) internal pure {
