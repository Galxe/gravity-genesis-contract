...
contract System {
    ...
    address internal constant VALIDATOR_MANAGER_UTILS_ADDR = 0x000000000000000000000000000000000000200c;
    ...
    modifier onlySystemJWKCaller() {
        require(
            msg.sender == address(this) ||  // ValidatorManager自己
            msg.sender == JWK_MANAGER_ADDR ||  // JWKManager
            msg.sender == SYSTEM_CALLER,  // 系统调用者
            "Unauthorized caller"
        );
        _;
    }
