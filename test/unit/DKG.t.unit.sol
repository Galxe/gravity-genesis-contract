...
contract DKGTest is Test, TestConstants {
    ...
    function test_start_shouldSucceed() public {
        ...
        IDKG.RandomnessConfig memory randomnessConfig = _createTestRandomnessConfig();
    ...
    function _createTestRandomnessConfig() internal pure returns (IDKG.RandomnessConfig memory) {
    ...
    function _createTestValidators() internal pure returns (IDKG.ValidatorConsensusInfo[] memory) {
        ...
        validators[0] = IDKG.ValidatorConsensusInfo({
            addr: address(0x1),
            pkBytes: "validator1_pk",
            votingPower: 100
        });
        validators[1] = IDKG.ValidatorConsensusInfo({
            addr: address(0x2),
            pkBytes: "validator2_pk",
            votingPower: 200
        });
        return validators;
    }
